...
description: 'YAML for people who already know JSON. Data types, nested structures, anchors, and the gotchas that trip everyone up. With side-by-side comparisons.'

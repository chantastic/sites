...
collection: epicreact
course: advanced-react-patterns
sequence: 6-1-state-reducer_solution
---
...
![TODO](./6-1-state-reducer_solution_1-reducer-is-not-a-function.gif)
...
![TODO](./6-1-state-reducer_problem.gif)

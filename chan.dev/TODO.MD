...
Implement a url-based search feature that lets me visit /whate-ever-i-want and it either visits the closest single match *or* provides a list of matches on the 404 page.
